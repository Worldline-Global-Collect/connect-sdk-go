...
// NewHelperBuilder creates a new HelperBuilder that will use the given secret key store.
...
// NewHelper creates a new Helper that will use the given secret key store.
