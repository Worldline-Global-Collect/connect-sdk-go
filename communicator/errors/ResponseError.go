...
// ResponseError is returned when a response was received from the Worldline Global Collect platform which indicates an error.
...
// Body gets the raw response body that was returned by the Worldline Global Collect platform.
func (e ResponseError) Body() string {
	return e.body
}

// Headers gets the headers that were returned by the Worldline Global Collect platform.
