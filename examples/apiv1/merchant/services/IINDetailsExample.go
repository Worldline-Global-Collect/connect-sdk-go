...
func iinDetailsExample() {
	...
	var body domain.GetIINDetailsRequest
	body.Bin = connectsdk.NewString("4567350000427977")

	response, err := client.V1().Merchant("merchantId").Services().GetIINdetails(body, nil)
